			   ...
			   console.log('true')
				 ...
				 {   console.log('flag===false');
				  ...
				  //  productHtml += getModalHTML(uniqueId, product, imgUrl); // Modal html maker call
					...
					{
					var productHtml = '<div class="product-list">'; // productlist start
					productHtml += '<img style="max-width:100%; max-height:100%;" src="' + imgUrl + '" class="img-responsive items" data-carid="myModal' + uniqueId + '" onclick="setSelectedProduct(this)" id="' + product.fields.id + '" alt=' + uniqueId + ' data-toggle="modal" data-target="#myModal' + uniqueId + '">'; // Product image
				  //  productHtml += getModalHTML(uniqueId, product, imgUrl); // Modal html maker call
					productHtml += '<div class="product-title">'; // product title start
	    ...
	    for (i = 0; i < parsedata[0].products.length; i += 2) {
	        ...
	        $('.add-items').append('<div class="row ">\
										<div class="col-xs-6">\
											...
											<div class="row border-outline">\
												<div class="col-xs-12 pic" >\
													<p><img src="./assets/img/like.png">' + parsedata[0].products[i].fields.brand + '</span></p>\
												</div>\
											</div>\
										</div>\
								<div class="col-xs-6">\
